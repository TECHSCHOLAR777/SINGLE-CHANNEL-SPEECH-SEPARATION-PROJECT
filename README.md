...
> **Last updated:** 2026-07-13 (training-cache pipeline built + tested — `train/cached_dataset.py`, `scripts/build_train_cache.py`, `scripts/evaluate_cascade.py`, `notebooks/kaggle_p2.py`; P1-INT2 validator now wires the padded expert; P2 first GPU run is the only remaining blocker. Earlier same-day: honesty reconciliation + pulse recount to 89/20/134 of 243)
