"""Frozen SR-CorrNet var-2-5 backbone wrapper for CALM-Sep (BLUEPRINT §3, §15.1).
...
class SRCorrNetWrapper:
    """Frozen SR-CorrNet var-2-5 with CALM-Sep patch set.
    ...
    def forward(
        ...
        """Run the frozen backbone and return all CALM-Sep internal signals.
