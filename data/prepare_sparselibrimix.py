"""
Prepare SparseLibriMix (test-only) for CA-MoSE — Phase 3 (P3-A2).
...
Usage
-----
    python data/prepare_sparselibrimix.py --output-dir /path/to/datasets
    python data/prepare_sparselibrimix.py --output-dir /path/to/datasets \\
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "overlap ratios, and verify the layout for CA-MoSE (P3-A2)."
        ),
    ...
    print("=" * 60)
    print("CA-MoSE  |  Prepare SparseLibriMix  |  Phase 3 (P3-A2)")
    print("=" * 60)
