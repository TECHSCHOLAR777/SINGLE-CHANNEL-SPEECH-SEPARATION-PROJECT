"""
Build a reverberant-noisy evaluation set from Libri3Mix — CA-MoSE Phase 1 (P1-A3, WHAMR! alt).
...
Usage
-----
    python data/make_reverb_eval.py --librimix-root /data/Libri3Mix \\
...
from data.augmentation import AugmentationConfig, AugmentationPipeline
...
def main() -> None:
    ...
    print("=" * 60)
    print("CA-MoSE  |  Reverberant-noisy eval set  |  Phase 1 (L3 / WHAMR! alt)")
    print("=" * 60)
