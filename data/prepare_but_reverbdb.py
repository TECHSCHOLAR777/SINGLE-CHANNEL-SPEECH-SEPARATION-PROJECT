...
from data.rir_bank import RirRecord, find_direct_path_peak, measure_t60
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Download and stage BUT ReverbDB (OpenSLR SLR17) for CALM-Sep evaluation.",
    ...
    print("=" * 60)
    print("CALM-Sep  |  BUT ReverbDB staging  |  OpenSLR SLR17")
    print("=" * 60)
