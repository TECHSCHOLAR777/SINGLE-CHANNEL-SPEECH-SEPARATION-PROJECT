"""
Prepare real WHAMR! (reverberant-noisy) for CA-MoSE — Phase 1 (P1-A3, gated).
...
-----
    ...
    python data/prepare_whamr.py --output-dir /data/WHAMR
...
def _deferred_note(reason: str) -> None:
    ...
    print(
        ...
        "    python data/make_reverb_eval.py --librimix-root <Libri3Mix> \\\n"
...
def main() -> None:
    ...
    print("=" * 60)
    print("CA-MoSE  |  Prepare WHAMR!  |  Phase 1 (P1-A3, gated)")
    print("=" * 60)
