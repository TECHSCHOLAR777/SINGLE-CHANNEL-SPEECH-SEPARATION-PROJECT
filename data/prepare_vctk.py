"""
Prepare the VCTK accent-diversity speaker pool for CA-MoSE — Phase 0 (P0-A4).
...
Usage
-----
    python data/prepare_vctk.py --output-dir /path/to/datasets
    python data/prepare_vctk.py --output-dir /path/to/datasets --max-speakers 20
    python data/prepare_vctk.py --output-dir /path/to/datasets \\
...
def main() -> None:
    ...
    print("=" * 60)
    print("CA-MoSE  |  Prepare VCTK accent pool  |  Phase 0 (P0-A4)")
    print("=" * 60)
