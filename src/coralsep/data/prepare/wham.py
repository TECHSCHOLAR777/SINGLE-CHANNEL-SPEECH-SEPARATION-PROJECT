...
CoRAL-Sep augmentation needs: ``AugmentationPipeline`` (data/augmentation.py) adds
...
Usage
-----
    python src/coralsep/data/prepare_wham.py --output-dir /path/to/datasets
    python src/coralsep/data/prepare_wham.py --output-dir /path/to/datasets \\
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Download and verify the WHAM! noise corpus for CoRAL-Sep augmentation "
            "(P1-A3, WHAM! only)."
        ),
    ...
    print("=" * 60)
    print("CoRAL-Sep  |  Prepare WHAM! noise  |  Phase 1 (P1-A3)")
    print("=" * 60)
    ...
    print("  python src/coralsep/data/prepare_sparselibrimix.py --output-dir ... \\")
