...
turns a clean CoralSepMixture into a training or evaluation example under a
named condition.
...
def apply_reverb(
    ...
    Args:
        mixture: A clean CoralSepMixture.
    ...
    Returns:
        A new CoralSepMixture. The input is not modified.
    """
    if record is None:
...
def apply_noise(
    ...
    Args:
        mixture: A CoralSepMixture, clean or already reverberated.
    ...
    Returns:
        A new CoralSepMixture with noise added to the observation.
    """
...
def apply_codec(
    ...
    this wrapper adapts them to the CoralSepMixture type and records the labels.

    Args:
        mixture: A CoralSepMixture at 8 kHz.
