...
Usage::
    ...
    python src/coralsep/data/prepare_dns4.py --out-dir data/dns4_subset --dry-run
    python src/coralsep/data/prepare_dns4.py --out-dir data/dns4_subset --target-gb 20
"""
