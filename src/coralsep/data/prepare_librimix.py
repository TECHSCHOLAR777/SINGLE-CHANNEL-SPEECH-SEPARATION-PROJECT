"""
Prepare Libri3Mix for CoRAL-Sep Phase 0.
...
Usage
-----
    python src/coralsep/data/prepare_librimix.py --output-dir /path/to/datasets
    python src/coralsep/data/prepare_librimix.py --output-dir /path/to/datasets \\
...
def main() -> None:
    ...
    print("=" * 60)
    print("CoRAL-Sep  |  Prepare Libri3Mix  |  Phase 0")
    print("=" * 60)
