...
from models.lora import ADAPTER_NAMES, LoRALibrary, LoRALinear, olora_penalty
    ...
    for epoch in range(1, epochs + 1):
        ...
        for batch in loader:
            ...
            for b in range(B):
                ...
                ref_b = references[b : b + 1]  # (1, K_ref, T) — calmsep_loss trims
                lg_b = lg_sep.float().unsqueeze(0) if lg_sep is not None else None
                sep_loss_b = calmsep_loss(waves_b, ref_b, lg_b, n_spks[b : b + 1])["total"]
