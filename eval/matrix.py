...
Runs CALM-Sep against the 8-condition × 4-N fixed eval set produced by
data/fixed_eval_generator.py and returns a structured results table.
...
def run_eval_matrix(
    ...
    """
    Run the CALM-Sep pipeline over all mixtures in eval_manifest.

    Args:
        pipeline: CalmSepPipeline instance.
    ...
    from train.losses import si_snr as _si_snr_torch
    import torch
