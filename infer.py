...
class CALMSepInference:
    ...
    def _load_all(self) -> None:
        ...
        from models.lora import ADAPTER_NAMES, LoRALibrary
        ...
        from models.band_recovery import BandRecoveryHead
        ...
        log.info("CALM-Sep ready on %s", dev)
    ...
    def _band_recover(
        ...
        from models.band_recovery import stft_to_waveform
...
def _parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="CALM-Sep: condition-aware speech separation")
    p.add_argument(
        "--checkpoint-dir",
        required=True,
